...
describe('<App />', () => {
  ...
  describe('<App /> main paragraph', () => {
    ...
    describe('<ul> tests', () => {
      ...
      it('Should have 100 <li> elements', () => {
        expect(wrapper.find('ul').children().length).toEqual(100);
      });
      it('Should say "quia et su" as the first 10 characters of the first <li> element', () => {
        expect(wrapper.find('ul').children().first().text()
          .substring(0, 10)).toEqual('quia et su');
      });
    });
  });
});
